...
window.onload = function() {
	...
	let canvas = document.getElementById("canvas"),
        ...
        height = canvas.height = window.innerHeight - 100,   //height of the canvas
        size = .3,                                    //determins size of each square
        ...
        context.translate(-width/3,height*1.3)
        ...
        function animate() {
            ...
            let angleLim = .0164, angleInc = size/80000;
        ...
        function create_square(p1,p2,p3,p4) {
            ...
            if (startWithWhite) {
                ...
                context.fillStyle = 'hsl(' + (time/2) + ', 100%, 60%)';
