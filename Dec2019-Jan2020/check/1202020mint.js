...
window.onload = function() {
	...
	let canvas = document.getElementById("canvas"),
        ...
        startWithWhite = true,          //switches from true to flase for each row to make sure the pattern is alike to a checker/chess board
                                       //
        lightness = 100,                //used in hsl ('hue', 'saturation', 'lightness');
        ...
        function animate() {
            ...
            setTimeout(window.requestAnimationFrame, .07, (animate));
        }
        ...
        function create_square(p1,p2,p3,p4) {
            ...
            if (startWithWhite) {
                ...
                context.fillStyle = 'hsl(' + (0) + ', 0%,  ' + lightness/1.7 +'%)';
                ...
                context.fillStyle = 'hsl(' + (183) + ', 100%, ' + lightness +'%)';
