...
//GLOBAL VARS
  ...
  NoiseSeed nSeedX1 = new NoiseSeed(2307.3939); //new NoiseSeed((float) Math.random()*1000 + 417.3939);
  NoiseSeed nSeedX2 = new NoiseSeed(2777.777);//new NoiseSeed((float) Math.random()*1000 + 777.777);
  NoiseSeed nSeedY1 = new NoiseSeed(2277.719);  //new NoiseSeed((float) Math.random()*1000 + 3939.719);
  NoiseSeed nSeedY2 = new NoiseSeed(2444.415826); //new NoiseSeed((float) Math.random()*1000 + 3141.5826);
...
void draw() {
  ...
  saveFrame("../../../../../../../Art/Renders/0135_AP/img_#####.png");
